...
class CursoForm(forms.ModelForm):
    """
    Formulario para crear y editar cursos de catequesis.
    Incluye presentación con Crispy Forms y validaciones automáticas del modelo.
    """
    class Meta:
        model = Curso
        fields = ['codigo', 'nombre', 'descripcion', 'costo', 'acta_nacimiento', 'acta_bautismo', 'acta_comunion', 'acta_matrimonio']
        ...
        self.helper.layout = Layout(
            ...
            Fieldset(
                ...
                Row(
                    ...
                    Column(Field('acta_bautismo'), css_class='col-md-3 mb-2'),
