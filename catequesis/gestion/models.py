...
class Catequista(BaseModel, AuditModel):
    """Modelo para catequistas, hereda datos personales y auditoría."""
    ...
    @property
    def grupos(self):
        """Devuelve los grupos asignados al catequista como string."""
...
class Padre(BaseModel, AuditModel):
    """Modelo para padres de estudiantes."""
    class Meta:
        verbose_name = 'Padre'
...
class Estudiante(BaseModel, AuditModel):
    """Modelo para estudiantes/catequizandos."""
...
class Curso(AuditModel):
    """Modelo para cursos de catequesis."""
...
class CicloCatequesis(models.Model):
    """Modelo para ciclos anuales de catequesis."""
...
class CursoAnual(models.Model):
    """Modelo para la relación entre curso y ciclo anual."""
...
class Grupo(models.Model):
    """Modelo para grupos de estudiantes dentro de un curso anual."""
...
class Inscripcion(AuditModel):
    """Modelo para inscripciones de estudiantes en grupos."""
