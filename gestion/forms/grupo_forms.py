...
class GrupoForm(forms.ModelForm):
    """
    Formulario para crear y editar grupos de estudiantes dentro de un curso anual.
    Incluye selección múltiple de catequistas y presentación con Crispy Forms.
    """
    class Meta:
        model = Grupo
    ...
    def __init__(self, *args, **kwargs):
        ...
        # El widget de catequistas ya está personalizado en widgets
